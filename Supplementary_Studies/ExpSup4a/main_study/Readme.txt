The text file "data_Exp3a_main.txt" contains the experimental data. In that file the columns are: 
...
The RMD file (Analysis_Exp3a_main.RMD) is the R-Markdown analysis script. 

The html file (Analysis_Exp3a_main.html) is a knitted (compiled) version of the analysis script (can be used for web view). 

The PDF file "results_binaryCauses_main.pdf" is a graph summarizing the results.

The MP4 file "Exp3a_main_demoVideo.mp4" is a demo video of the study.

The PDF file "Exp3a_main_printVersion.pdf" is a print version of the online experiment.
