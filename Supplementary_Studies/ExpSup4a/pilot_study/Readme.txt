The text file "data_Exp3a_pilot.txt" contains the experimental data. In that file the columns are: 
...
- "Justification":		subjects wrote short explanations for their strength ratings (only in the pilot study)
- "Age":			age in years
...
The RMD file (Analysis_Exp3a_pilot.RMD) is the R-Markdown analysis script. 

The html file (Analysis_Exp3a_pilot.html) is a knitted (compiled) version of the analysis script (can be used for web view). 

The PDF file "results_binaryCauses_pilot01.pdf" is a graph summarizing the results.
