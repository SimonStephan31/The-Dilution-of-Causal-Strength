...
"sID": 				subject ID 
"Effects":			Counterbalancing factor: whether the effect aliens were the blue or the yellow aliens
"Target":			Counterbalancing factor: whether the target alien was the first, second, or third 
"Multiple_Effects":		Counterbalancing factor coding whether the multiple-effects common cause was red or blue
"strength_multiple":		DV (subjects' ratings for the 3-effects common cause)
"strength_single":		DV (subjects' ratings for the 1-effect cause)
...
- The ".pdf" file "results_graph_lines.pdf" is a results graph
