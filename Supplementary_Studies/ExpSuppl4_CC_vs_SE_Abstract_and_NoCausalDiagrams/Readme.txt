...
"sID": 				subject ID 
"Q_order":			Counterbalancing factor: whether subjects first rated the common cause or the single-effect cause
"Target_effect":		Counterbalancing factor: whether the target effect was the first, second, or third 
"multiple":			DV (subjects' ratings for the 3-effects common cause)
"single":			DV (subjects' ratings for the 1-effect cause)
