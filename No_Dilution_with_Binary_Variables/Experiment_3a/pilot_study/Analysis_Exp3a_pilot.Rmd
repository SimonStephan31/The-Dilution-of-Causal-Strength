---
title: "No dilution of causal strength with truely binary variables (Pilot of Exp. 3a)"
...
```{r}
tdata <- read.delim("data_Exp3a_pilot.txt", header=TRUE, sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
```
