...
dat <- subset(tdata_sub, Process == "generative" & Valence == "positive")


# since we have a repeated-meausres design, we now need the correlations of the ratings
library(dplyr) # for pipe operator
tdata %>% filter(Process == "generative", Valence == "positive") -> t
...
# condition: preventive cause and positive effects
dat <- subset(tdata_sub, Process == "preventive" & Valence == "positive")


# since we have a repeated-meausres design, we now need the correlations of the ratings
library(dplyr) # for pipe operator
tdata %>% filter(Process == "preventive", Valence == "positive") -> t
r <- cor(t$single_strength_rating, t$multiple_strength_rating)
r
...
# condition: generative cause and negative effects
dat <- subset(tdata_sub, Process == "generative" & Valence == "negative")


# since we have a repeated-meausres design, we now need the correlations of the ratings
library(dplyr) # for pipe operator
tdata %>% filter(Process == "generative", Valence == "negative") -> t
r <- cor(t$single_strength_rating, t$multiple_strength_rating)
r
...
# condition: preventive cause and negative effects
dat <- subset(tdata_sub, Process == "preventive" & Valence == "negative")


# since we have a repeated-meausres design, we now need the correlations of the ratings
library(dplyr) # for pipe operator
tdata %>% filter(Process == "preventive", Valence == "negative") -> t
r <- cor(t$single_strength_rating, t$multiple_strength_rating)
r
...
Difference Plots for the dilution effects (unstandardized):
