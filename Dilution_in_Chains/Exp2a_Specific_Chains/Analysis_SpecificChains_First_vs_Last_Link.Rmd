...
apples_dat %>% cohens_d(value ~ link, 
                        paired = TRUE, 
                        ci = TRUE, 
                        conf.level = 0.95,
                        ci.type = "perc",
