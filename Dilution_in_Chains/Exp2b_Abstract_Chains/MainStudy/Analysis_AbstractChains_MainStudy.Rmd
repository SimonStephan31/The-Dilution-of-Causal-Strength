...
library(effsize)
cohen.d(tdata_14$value,tdata_14$variable, paired = T)
...
dat_1st <- subset(tdata_14, variable == "1st")
dat_4th <- subset(tdata_14, variable == "4th")

cor.test(dat_1st$value, dat_4th$value)
